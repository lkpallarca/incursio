...
export default function HomePage() {
  ...
  return (
    <section className='homepage'>
      ...
      <div>In battle, the enemy will generate a random number, while you have to select one or two numbers from 1 to 6.</div>
      ...
      <div>However, if your number is less than the enemy's, then they will deal damage to you equal to the difference between the totals plus their own damage.</div>
